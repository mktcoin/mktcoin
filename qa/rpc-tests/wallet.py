...
class WalletTest (MKTcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 MLM from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 MLM with subtract fee from amount
        ...
        # Sendmany 10 MLM with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/mktcoin/mktcoin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
