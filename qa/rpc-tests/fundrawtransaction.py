...
class RawTransactionsTest(MKTcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid mktcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid mktcoin address" in e.error['message'])
