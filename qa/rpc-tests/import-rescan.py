...
import RPC call and node 0 sends MLM to it. Then other nodes import the
...
In the second part of the test, node 0 sends more MLM to each address, and the
...
class ImportRescanTest(MKTcoinTestFramework):
    def __init__(self):
        super().__init__()
