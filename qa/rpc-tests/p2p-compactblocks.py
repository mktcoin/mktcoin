...
# TestNode: A peer we use to send messages to mktcoind, and store responses.
...
class CompactBlocksTest(MKTcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes mktcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that mktcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for mktcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # mktcoind will not send blocktxn responses for blocks whose height is
