...
#ifndef MKTCOIN_QT_MKTCOINUNITS_H
#define MKTCOIN_QT_MKTCOINUNITS_H
...
*/
class MKTcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MKTcoinUnits(QObject *parent);

    /** MKTcoin units.
      @note Source: https://en.mktcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MLM,
...
typedef MKTcoinUnits::Unit MKTcoinUnit;

#endif // MKTCOIN_QT_MKTCOINUNITS_H
