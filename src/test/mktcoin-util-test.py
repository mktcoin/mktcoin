...
# Copyright 2016 The MKTcoin Core developers
...
help_text="""Test framework for mktcoin utils.

Runs automatically during `make check`.

Can also be run manually from the src directory by specifying the source directory:

test/mktcoin-util-test.py --srcdir='srcdir' [--verbose]
"""
...
if __name__ == '__main__':
    ...
    bctest.bctester(srcdir + "/test/data", "mktcoin-util-test.json", buildenv)
