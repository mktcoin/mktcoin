...
#ifndef MKTCOIN_TEST_SCRIPTNUM10_H
#define MKTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from MKTcoin Core 0.10.0, for cross-comparison.
 */
public:
