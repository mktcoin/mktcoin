...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1503190481, 488002, 0x1e0fffff, 1, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xdcbcae705b0af93fe0aaad1cc588ba243d02ed543d09bf5b167127c05cfcd5ce"));
        //assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.push_back(CDNSSeedData("default", "34.253.106.148", true));
	vSeeds.clear();
...
public:
	...
	vSeeds.clear();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,221);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,50);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,93);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x91)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x91)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
