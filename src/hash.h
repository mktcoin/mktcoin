...
#ifndef MKTCOIN_HASH_H
#define MKTCOIN_HASH_H
...
/** A hasher class for MKTcoin's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for MKTcoin's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
