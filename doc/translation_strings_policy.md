...
This document provides guidelines for internationalization of the MKTcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mktcoin_en.ts` remains unchanged.
