MKTcoin Core version 0.13.2 is now available from:

  <https://mktcoin.org/bin/mktcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update mktcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow mktcoin-tx to create v2 transactions (btcdrak)
