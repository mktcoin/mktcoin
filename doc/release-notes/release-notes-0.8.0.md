MKTcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mktcoin/files/MKTcoin/mktcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the MKTcoin
...
New/changed settings (command-line or mktcoin.conf file)
--------------------------------------------------------
