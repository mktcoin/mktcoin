MKTcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/mktcoin/files/MKTcoin/mktcoin-0.5.4/
...
http://gitorious.org/mktcoin/mktcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix MKTcoin-Qt notifications under Growl 1.3.
Increase required age of MKTcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMKTcoin properly when installing MKTcoin-Qt over it. (Windows)
