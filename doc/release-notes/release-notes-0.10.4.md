MKTcoin Core version 0.10.4 is now available from:

  <https://mktcoin.org/bin/mktcoin-core-0.10.4/>
...
- #6953 `43c2789` Split mktcoin-tx into its own package
- #6953 `dfe0d4d` Include mktcoin-tx binary on Debian/Ubuntu
