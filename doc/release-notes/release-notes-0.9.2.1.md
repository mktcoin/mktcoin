MKTcoin Core version 0.9.2.1 is now available from:

  https://mktcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MLM to 0.01 MLM
...
- Fix "Start mktcoin on system login"
