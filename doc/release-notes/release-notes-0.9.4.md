MKTcoin Core version 0.9.4 is now available from:

  https://mktcoin.org/bin/0.9.4/
...
this update is incompatible with the MKTcoin system and could lead to consensus
forks.

MKTcoin Core released binaries from https://mktcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~mktcoin/+archive/ubuntu/mktcoin
- A third-party or self-compiled MKTcoin Core

upgrade to MKTcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
