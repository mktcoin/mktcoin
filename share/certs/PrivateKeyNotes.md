...
unlocked to sign the MKTcoin-Qt.app bundle.
...
allowing somebody to distribute a MKTcoin-Qt.app or mktcoin-qt-setup.exe with a valid
...
that the mktcoin-qt.exe file inside the installer had not been tampered with.
